...
public class NotificationServiceChat extends IntentService {

    private static final String TAG = "ServicioChat";
    private static final String CHANNEL_ID = "servicio_notificaciones-chat" ;
    ...
    public NotificationServiceChat() {
    ...
    public void start() {
        ...
        ref = database.getReference().child("chat").child(currentFirebaseUser.getUid());
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String prevChildKey) {
                ...
                Log.i(TAG, "escuché un cambio");
                    ...
                    if (mapa.get(dataSnapshot.getKey()) < changedStory.getIntentos()) {
                        ...
                        mBuilder.setContentTitle("Te enviaron un mensaje!");
                        mBuilder.setContentText("te envió un mensaje");
